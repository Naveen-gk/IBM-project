...
COS_API_KEY_ID="erYOo-lq7dwN0LigQFZUw9ZhSjUSZPeUrZl8VaIOZwoC"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/11d1eefda09948f1a3075e4fab8e60f6:712106a7-5039-4a5e-8c83-c72c3638249a::"
...
@app.route('/')
def index():
    files = get_bucket_contents('dinabucket')
