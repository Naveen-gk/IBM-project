...
COS_API_KEY_ID="Tbzg1Sk7CJTAyMrbUtBZZxZKEX_Rm_8-wtlv1VgCTs4Z"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/3dfdfb9d36d645d9acc39b47c955da9f:53bb2433-ad07-44e3-b599-2acd30bd93eb::"
...
@app.route('/')
def index():
    files = get_bucket_contents('keshbucket')
